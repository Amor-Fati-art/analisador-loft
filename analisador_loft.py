...
• Troca de chuveiro – Aprovar em caso de troca de modelo ou quando houver dano visível; negar quando estiver queimado ou quando não houver chuveiro na vistoria de saída.
...
• Iluminação embutida (spots, luminárias de teto que integram a instalação) – Aprovar quando danificados/quebrados; negar quando apenas queimados.
...
• Desobstrução – Aprovar apenas quando o entupimento for causado por mau uso do inquilino; caso contrário, negar.
